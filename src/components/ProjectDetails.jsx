      ...
      >
        ...
        <div style={{ padding: '0 48px 48px', marginTop: -60, position: 'relative', zIndex: 10 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 32 }}>
            <div>
              <p style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 11, color: '#00aaff', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 8 }}>
                {project.category} // {project.year}
              </p>
              <h2 style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 48, color: '#e8edf2', textTransform: 'uppercase', margin: 0, letterSpacing: '0.04em' }}>
                {project.title}
              </h2>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
            <div style={{ flex: '1 1 400px' }}>
              <h4 style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 13, color: '#00aaff', opacity: 0.8, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 16 }}>
                Project Resume
              </h4>
              <p style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.8)', lineHeight: 1.8, opacity: 0.9 }}>
                {project.resume}
              </p>
            </div>
            ...
            <div style={{ flex: '1 1 250px', display: 'flex', flexDirection: 'column', gap: 32 }}>
              ...
              <div>
                <h4 style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 13, color: '#00aaff', opacity: 0.8, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 12 }}>
                  Time Spent
                </h4>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 12, borderBottom: `2px solid rgba(255,51,102,0.5)`, paddingBottom: 6 }}>
                  <span style={{ fontSize: 20 }}>⏱</span>
                  <span style={{ fontFamily: "'Matemasie', sans-serif", fontSize: 18, color: '#e8edf2', fontWeight: 'bold' }}>
                    {project.timeSpent}
                  </span>
                </div>
              </div>
